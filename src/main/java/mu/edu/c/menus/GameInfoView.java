...
public class GameInfoView extends JPanel{
	...
	public GameInfoView(){
			...
			btnViewWeapons.addMouseListener(new MouseAdapter() {
				//change button when mouse is hovered over it
				@Override
				public void mouseEntered(MouseEvent e) {
					buttonEntered(btnViewWeapons);
				}
				//reset button after mouse leaves
				public void mouseExited(MouseEvent e) {
					buttonExited(btnViewWeapons);
				}
			});
			
			btnViewCharacters.addMouseListener(new MouseAdapter() {
				
				@Override
				public void mouseEntered(MouseEvent e) {
					buttonEntered(btnViewCharacters);
				}
				public void mouseExited(MouseEvent e) {
					buttonExited(btnViewCharacters);
				}
			});
			
			btnViewEnemies.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseEntered(MouseEvent e) {
					buttonEntered(btnViewEnemies);
				}
				public void mouseExited(MouseEvent e) {
					buttonExited(btnViewEnemies);
				}
			});
		...
		private void initializeButtons(GridBagConstraints gbc) {
			...
			//Credits
			btnViewEnemies.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
				}
			});
